...
export type AppPage = "home" | "bindings" | "export" | "history" | "settings"

export default function AppHeader({ page, onNavigate }: { page: AppPage; onNavigate: (page: AppPage) => void }) {
    const { t } = useI18n()
    const entries: Array<[AppPage, string]> = [["home", t.nav.home], ["bindings", t.nav.bindings], ["export", t.nav.export], ["history", t.nav.history], ["settings", t.nav.settings]]
