...
export interface InsightsResponse { generatedAt:string;roleOverview:RoleOverview;insights:Insight[];buildingAreas:InsightBuildingArea[];memoryPrompt?:MemoryPrompt }
